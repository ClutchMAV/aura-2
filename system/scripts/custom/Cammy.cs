...
public class CammyBaseScript : NpcScript
{
	public override void Load()
	{
        SetName("<mini>DYER</mini> Cammy");
		SetRace(10002);
		SetBody(height: 0.1f);
        SetFace(skinColor: 25, eyeType: 42, eyeColor: 134, mouthType: 2);
		SetLocation(1, 12424, 38022, 33);

        EquipItem(Pocket.Face, 4908, 0x00F49D31, 0x00605765, 0x0000B8C3);
        EquipItem(Pocket.Hair, 4087, 0x100000fe, 0x50004b47, 0x10000000);
        EquipItem(Pocket.Armor, 15934, 0x600001b1, 0x60000000, 0x60000f0f);
        EquipItem(Pocket.Shoe, 17278, 0x1000000F, 0x60000000, 0x60000f0f);
        EquipItem(Pocket.Head, 18394, 0x10000000, 0x10000074, 0x1000000F);
        EquipItem(Pocket.Glove, 210146, 0x10000000, 0x10000015, 0x1000000F);
		
		AddPhrase("IM SO FUCKING USEFUL YEAAAAAAAAAAAAAAA.");
		AddPhrase("Yukkiii.");
		AddPhrase(". 3.");
		AddPhrase("KITTY EARSS");
	}
...
public class CammyDyeShop : NpcShopScript
{
	public override void Setup()
	{
        Add("Dye", 63030, 0x600001b1, 0x60000000, 0x60000f0f);		// Dye
        Add("Dye", 63030, 0x600001b1, 0x60000000, 0x60000f0f);		// Dye
        Add("Dye", 63030, 0x600001b1, 0x60000000, 0x60000f0f);		// Dye
        Add("Dye", 63030, 0x600001b1, 0x60000000, 0x60000f0f);		// Dye
        Add("Dye", 63030, 0x600001b1, 0x60000000, 0x60000f0f);		// Dye
