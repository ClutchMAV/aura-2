...
public class MomoDyeShopBaseScript : NpcScript
{
	public override void Load()
	{
        SetName("Momo Domo");
        SetRace(9001);
        SetBody(height: 1.0f, weight: 1.0f, upper: 1.0f, lower: 1.0f);
        SetFace(skinColor: 16, eyeType: 42, eyeColor: 13, mouthType: 2);
        SetStand("human/female/anim/female_natural_stand_npc_Dilys_retake");
        SetLocation(1, 11207, 37865, 58);

        EquipItem(Pocket.Face, 5906, 0x00596131, 0x00FFEEC6, 0x006F0017);
        EquipItem(Pocket.Hair, 3164, 0x10000015, 0x00D57527, 0x00D57527);
        EquipItem(Pocket.Armor, 15935, 0x1000000f, 0x10000000, 0x1000000F);
        EquipItem(Pocket.Shoe, 17390, 0x1000000f, 0x10000000, 0x1000000F);
        EquipItem(Pocket.Head, 210356, 0x1000000f, 0x00000000, 0x00000000);
        EquipItem(Pocket.Robe, 220104, 0x1000000F, 0x10000000, 0x1000000F);
        EquipItem(Pocket.Glove, 16188, 0x1000000F, 0x1000000f, 0x1000000F);
        EquipItem(Pocket.RightHand2, 40810, 0x000000, 0xC0C0C0, 0xFFD700);
		
		AddPhrase("You didnt see shit :U.");
		AddPhrase("; u;.");
		AddPhrase("Ermwgwed DYES!");
		AddPhrase("NOO NYAN NOOOO");
	}
...
public class MomoDyeShop : NpcShopScript
{
	public override void Setup()
	{
        Add("Dye", 63030, 0x00ffc7c6, 0x50004b47, 0x10000000);		// Dye
        Add("Dye", 63030, 0x00ffc7c6, 0x50004b47, 0x10000000);		// Dye
        Add("Dye", 63030, 0x00ffc7c6, 0x50004b47, 0x10000000);		// Dye
        Add("Dye", 63030, 0x00ffc7c6, 0x50004b47, 0x10000000);		// Dye
        Add("Dye", 63030, 0x00ffc7c6, 0x50004b47, 0x10000000);		// Dye
        ...
        Add("Dye", 63030, 0x00ffc7c6, 0x50004b47, 0x10000000);		// Dye
        Add("Dye", 63030, 0x00ffc7c6, 0x50004b47, 0x10000000);		// Dye
        Add("Dye", 63030, 0x1000000F, 0x50004b47, 0x10000000);		// Dye
        Add("Dye", 63030, 0x1000000F, 0x50004b47, 0x10000000);		// Dye
        Add("Dye", 63030, 0x1000000F, 0x50004b47, 0x10000000);		// Dye
        Add("Dye", 63030, 0x1000000F, 0x50004b47, 0x10000000);		// Dye
        Add("Dye", 63030, 0x1000000F, 0x50004b47, 0x10000000);		// Dye
        ...
        Add("Dye", 63030, 0x1000000F, 0x50004b47, 0x10000000);		// Dye
        Add("Dye", 63030, 0x1000000F, 0x50004b47, 0x10000000);		// Dye
        Add("Dye", 63030, 0x10000000, 0x50004b47, 0x1000000F);		// Dye
        Add("Dye", 63030, 0x10000000, 0x50004b47, 0x1000000F);		// Dye
        Add("Dye", 63030, 0x10000000, 0x50004b47, 0x1000000F);		// Dye
        Add("Dye", 63030, 0x10000000, 0x50004b47, 0x1000000F);		// Dye
        Add("Dye", 63030, 0x10000000, 0x50004b47, 0x1000000F);		// Dye
